...
const GroupCard = ({ groupInfo, hasLink=true }: GroupCardProps) => {
  ...
  return (
    <div className="h-[7.938rem] bg-[#FFF] rounded-[0.75rem] shadow-group-card">
      <div className="h-full flex justify-start items-center p-[0.5rem] gap-[0.563rem]">
        <div className="h-24 w-24 min-w-24 bg-[#F2F2F2] rounded-[0.75rem] overflow-hidden">
