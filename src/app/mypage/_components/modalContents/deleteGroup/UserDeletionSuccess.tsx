  ...
  return (
    <>
      <div className="w-full py-6 text-left">
        <h4 className="mb-1 text-lg font-semibold text-gray-900">회원 탈퇴가 완료되었어요</h4>
        <div className="text-gray-500">다시 뵙기를 기다리고 있을게요!</div>
      </div>
...
export default UserDeletionSuccess;
